...
export default function UserProfile(props: {
    ...
    const { userData } = useGetUser(props.session?.id)
    return (
        <>
            <main className=" px-4 lg:px-20 py-5 flex flex-col lg:flex-row gap-2">
                <div className="flex flex-col gap-2 flex-[70%]">
                    ...
                    <Tabs defaultValue="about" className="mt-52 w-full lg:mt-24">
                        <TabsList className="grid lg:hidden w-full grid-cols-2">
                            ...
                            <TabsTrigger value="suggested-therapist">Suggested Therapist</TabsTrigger>
                        </TabsList>
                        ...
                        <TabsContent value="suggested-therapist">
                ...
                <div className="pb-5 hidden lg:block flex-[30%] sticky top-0">
                    <ScrollArea className={cn("h-auto lg:h-screen lg:px-4")} >
                        <div className=" sticky top-0 bg-background p-2 py-1 z-10">Suggested Therapist</div>
                        {[...Array(10)].map((_, i) => (
                            <Card key={i} className={cn("shadow-none w-full mt-2 first:mt-0 last:mb-2 z-0")}>
                                <CardContent className="p-4">
                                    <div className="flex items-center gap-2">
                                        <Avatar className="h-12 w-12">
                                            <AvatarImage src={faker.image.urlLoremFlickr({ category: "doctors" })} className="object-cover" />
